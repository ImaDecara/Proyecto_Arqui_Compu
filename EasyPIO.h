 ...
 *Joshua_Vasquez@hmc.edu Last Modified: 	5 April 2014
 *						Sarah_Lichtman@hmc.edu &
 *Joshua_Vasquez@hmc.edu 15 August 2014 David_Harris@hmc.edu  (simplify pinMode)
 *
...
void pwmInit() {
    ...
    CM_PWMDIV =
            PWM_CLK_PASSWORD | (PLL_CLOCK_DIVISOR << 12);  // PWM Freq = 25 MHz
